...
// die();
    if (!isset($_SESSION['otp'][$phone]) || $_SESSION['otp'][$phone] != $user_otp) {
        echo "<script>alert('OTP verification failed'); window.location='https://www.wbnarayanaschools.in/andul/';</script>";
        exit;
    }
  ...
  if (isset($phone) && $phone!='') {
    ...
    //     $conn->close();
        ...
        if(isset($from_for) && $from_for=='feesstructure'){
          ...
          if(isset($_POST['downloadBrochure']) && $_POST['downloadBrochure']=='YES'){
                ...
                if(isset($feesStucture) && $feesStucture=='YES'){
                    echo "<script>
                    window.location = 'https://www.wbnarayanaschools.in/andul/thankyou.php?branch=".$branch."&feesstructure=".$feesStucture."';
                    </script>";
                }else{
            ...
            if(isset($_POST['downloadBrochure']) && $_POST['downloadBrochure']=='YES'){
                ...
                if(isset($feesStucture) && $feesStucture=='YES'){
                    ...
                    echo "<script language='javascript' type='text/javascript'> 
                    window.location = 'https://www.wbnarayanaschools.in/andul/thankyou.php';</script>";
        ...
        echo "<script language='javascript' type='text/javascript'> 
          ...
          window.location = 'https://www.wbnarayanaschools.in/andul/';</script>";  
      }
